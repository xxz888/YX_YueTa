...
@interface YTLoginPwdViewController ()<UITextFieldDelegate>
...
@implementation YTLoginPwdViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    [self setNavigationBarTitle:@"登录密码"];
