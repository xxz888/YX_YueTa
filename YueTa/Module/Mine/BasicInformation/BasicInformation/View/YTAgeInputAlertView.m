...
@property (nonatomic, copy) AgeInputBlock ageInputBlock;
...
- (void)confirmButtonClicked {
    ...
    if (self.ageInputBlock) {
        self.ageInputBlock(self.textField.text);
    }
    [self dissmiss];
}
